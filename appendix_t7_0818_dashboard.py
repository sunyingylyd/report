...
<div class="grid" style="margin-top:14px">
  ...
  <div class="card chart"><h3>本周 vs 累计</h3><p>本周提单用户 / 本周首次转化 / 本周放款</p><div class="box"><canvas id="c8"></canvas></div></div>
</div>
<div class="grid" style="margin-top:14px">
...
new Chart(document.getElementById('c8'), {type:'bar', data:{labels:['本周提单用户','本周新增首次','本周放款单','累计提单','累计放款'],
  datasets:[{label:'人数/单量', data:[k.n_apply_week, k.n_first_week, k.n_remit_week, k.n_apply, k.n_remit],
    backgroundColor:[col.cy, col.pk, col.am, col.gr, 'rgba(67,199,231,.45)']}]}, options:base(false)});
